...
echo_and_run cd "/home/lmk/weed_killing/src/vision_opencv-noetic/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/lmk/weed_killing/build/vision_opencv-noetic/image_geometry \
    build --build-base "/home/lmk/weed_killing/build/vision_opencv-noetic/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
