...
(cl:in-package weed_killing-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <QueryServoAngle-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QueryServoAngle-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name weed_killing-srv:<QueryServoAngle-request> is deprecated: use weed_killing-srv:QueryServoAngle-request instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <QueryServoAngle-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader weed_killing-srv:id-val is deprecated.  Use weed_killing-srv:id instead.")
  (id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<QueryServoAngle-request>)))
  ...
  "weed_killing/QueryServoAngleRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'QueryServoAngle-request)))
  "Returns string type for a service object of type 'QueryServoAngle-request"
  "weed_killing/QueryServoAngleRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <QueryServoAngle-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QueryServoAngle-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name weed_killing-srv:<QueryServoAngle-response> is deprecated: use weed_killing-srv:QueryServoAngle-response instead.")))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <QueryServoAngle-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader weed_killing-srv:angle-val is deprecated.  Use weed_killing-srv:angle instead.")
  (angle m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<QueryServoAngle-response>)))
  ...
  "weed_killing/QueryServoAngleResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'QueryServoAngle-response)))
  "Returns string type for a service object of type 'QueryServoAngle-response"
  "weed_killing/QueryServoAngleResponse")
