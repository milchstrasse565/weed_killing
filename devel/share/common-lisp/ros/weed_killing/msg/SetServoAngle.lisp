...
(cl:defmethod cl:initialize-instance :after ((m <SetServoAngle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetServoAngle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name weed_killing-msg:<SetServoAngle> is deprecated: use weed_killing-msg:SetServoAngle instead.")))
...
(cl:defmethod angle-val ((m <SetServoAngle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader weed_killing-msg:angle-val is deprecated.  Use weed_killing-msg:angle instead.")
  (angle m))
