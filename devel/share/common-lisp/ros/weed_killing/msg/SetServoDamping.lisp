...
(cl:in-package weed_killing-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <SetServoDamping>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetServoDamping)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name weed_killing-msg:<SetServoDamping> is deprecated: use weed_killing-msg:SetServoDamping instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <SetServoDamping>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader weed_killing-msg:id-val is deprecated.  Use weed_killing-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'power-val :lambda-list '(m))
(cl:defmethod power-val ((m <SetServoDamping>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader weed_killing-msg:power-val is deprecated.  Use weed_killing-msg:power instead.")
  (power m))
